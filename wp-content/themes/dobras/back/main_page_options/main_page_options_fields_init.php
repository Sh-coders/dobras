<?php
//Содержит массив для настройки опциональных полей страницы админпанели
function main_page_custom_setting() {
    ...
    $args = [
        ...
        ['main_page_slider_options', 'Количество проектов, который будут отображаться в слайдере', 'main_page_num_projects', '',
...
get_template_part( '/back/make_field.php');
get_template_part( '/back/render_settings.php');
?>